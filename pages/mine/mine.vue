<template>
	<view class="page_content">
		<view class="header">
			<image class="btn" src="/static/mine/icon_scan.png"></image>
			<text class="title">会员中心</text>
			<image class="btn" src="/static/mine/icon_msg.png"></image>
		</view>
		<image class="logo" src="/static/mine/head.png"></image>
			...
			<template v-for="(vip, i) in vips">
				<swiper-item :key="'vip_'+i">
					<view :class="['swiper-item',bigIdx === i ? 'big' : 'small']" :style="{background:vip.bg,'box-shadow':vip.shadow}">
						<image class="img" src="/static/mine/icon_vip.png"></image>
	...
	export default {
		data() {
			return {
				...
				tasks: [{
						icon: '/static/mine/icon_signin.png',
						name: '连续7天签到',
						desc: '连续签到获得7积分奖励'
					},
					{
						icon: '/static/mine/icon_profile.png',
						name: '完善个人信息',
						desc: '完善信息获得7积分奖励'
					},
					{
						icon: '/static/mine/icon_friend.png',
						name: '邀请好友参加',
						desc: '邀请好友获得7积分奖励'
					}
				],
				welfare: [{
						icon: '/static/mine/icon_evaluate.png',
						name: '专属礼包'
					},
					{
						icon: '/static/mine/icon_gift.png',
						name: '生日礼包'
					},
					{
						icon: '/static/mine/icon_score.png',
						name: '我的积分'
					},
					{
						icon: '/static/mine/icon_other.png',
						name: '其他礼包'
					}
				]
